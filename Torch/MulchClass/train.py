...
corename = opt.save_name+"_th-"+str(int(threthold*10))+"_lr-"+str(str(int(learning_rate**(-1))).count("0"))+"_test"+opt.annotation_file.split("/")[-1]
...
plt.savefig(os.path.join(IMAGE_PATH,outputcore+'.png'))
print("save to "+outputcore+".png")
...
save_file = os.path.join(IMAGE_PATH, outputcore+"_denorm.jpg")
