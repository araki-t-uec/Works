...
class SoundBasedTwostreamNet(nn.Module):
    ## input (224 x 224 x 3) (20 x 94)
    def __init__(self):
        super(SoundBasedTwostreamNet, self).__init__()
        self.features_1 = nn.Sequential(
            nn.Conv2d(3, 64, 3, padding=1),
            nn.ReLU(inplace=True),
            nn.Conv2d(64, 64, 3, padding=1),
